...
class CondoManagementPage extends StatefulWidget {
  @override
  _CondoManagementPageState createState() => _CondoManagementPageState();
}
...
class _CondoManagementPageState extends State<CondoManagementPage> {
  ...
  TextFormField _buildPriceInput() => TextFormField(
        initialValue:
            _condo.condoPrice == null ? '0' : _condo.condoPrice.toString(),
  ...
  TextFormField _buildPhoneInput() => TextFormField(
        initialValue:
            _condo.condoPhone == null ? '0' : _condo.condoPhone.toString(),
  ...
  AppBar _buildAppBar() => AppBar(
        centerTitle: false,
        title: Text(_editMode ? 'Edit Condo' : 'เพิ่มที่พัก'),
            ...
            onPressed: () async {
              ...
              if (_editMode) {
                try {
                  ...
                  final message = "";
                  await NetworkService().editAllCondoDio(null, _condo);
                ...
                Navigator.pushNamedAndRemoveUntil(
                    context, AppRoute.CondoBodyPageRoute, (route) => false);
              } else {
                try {
                  Navigator.pop(context);
                  final message = "";
