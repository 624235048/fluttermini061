...
class DetailMansionPage extends StatefulWidget {
  @override
  _DetailMansionPageState createState() => _DetailMansionPageState();
}

class _DetailMansionPageState extends State<DetailMansionPage> {
  final controller = TextEditingController();
  Mansion _mansionModel;
  double rating = 0;
  @override
  void initState() {
    _mansionModel = new Mansion();
    super.initState();
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    API.MANSION_IMAGE + _mansionModel.msImage,
                    scale: 0.5,
                  ),
                ),
              ),
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'ที่อยู่ :' + _mansionModel.msLocation,
                      ...
                      Text(
                        'สิ่งอำนวย :' + _mansionModel.msFacilities,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'ประเภทห้องพัก :' + _mansionModel.msLimitedroom,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'เบอร์โทรศัพท์ :' + _mansionModel.msPhone,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        "ราคา : " + _mansionModel.msPrice + " Bath. ",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 20,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Share.share('ข้อมูลที่พัก : ' +
                                  _mansionModel.msImage +
                                  '  ' +
                                  _mansionModel.msName +
                                  '  ' +
                                  _mansionModel.msLocation +
                                  '  ' +
                                  _mansionModel.msFacilities +
                                  '  ' +
                                  _mansionModel.msLimitedroom +
                                  '  ' +
                                  _mansionModel.msPhone +
                                  '  ' +
                                  _mansionModel.msPrice);
