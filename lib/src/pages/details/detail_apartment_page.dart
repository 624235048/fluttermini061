...
class DetailApartmentPage extends StatefulWidget {
  @override
  _DetailApartmentPageState createState() => _DetailApartmentPageState();
}

class _DetailApartmentPageState extends State<DetailApartmentPage> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    API.APARTMENT_IMAGE + _apartmentModel.apmImage,
                    scale: 0.5,
                  ),
                ),
              ),
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'ที่อยู่ :' + _apartmentModel.apmLocation,
                      ...
                      Text(
                        'สิ่งอำนวย :' + _apartmentModel.apmFacilities,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'ประเภทห้องพัก :' + _apartmentModel.apmLimitedroom,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'เบอร์โทรศัพท์ :' + _apartmentModel.apmPhone,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        "ราคา : " + _apartmentModel.apmPrice + " Bath. ",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 20,
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Share.share('ข้อมูลที่พัก : ' +
                                  _apartmentModel.apmImage +
                                  '  ' +
                                  _apartmentModel.apmName +
                                  '  ' +
                                  _apartmentModel.apmLocation +
                                  '  ' +
                                  _apartmentModel.apmFacilities +
                                  '  ' +
                                  _apartmentModel.apmLimitedroom +
                                  '  ' +
                                  _apartmentModel.apmPhone +
                                  '  ' +
                                  _apartmentModel.apmPrice);
                            },
                          ),
                        ],
                      ),
