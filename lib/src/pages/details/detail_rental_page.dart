                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'ที่อยู่ :' + _domitoryModel.dmLocation,
                      ...
                      Text(
                        'สิ่งอำนวย :' + _domitoryModel.dmFacilities,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'ประเภทห้องพัก :' + _domitoryModel.dmLimitedroom,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'เบอร์โทรศัพท์ :' + _domitoryModel.dmPhone,
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(
                      ...
                      Text(
                        "ราคา : " + _domitoryModel.dmPrice + " Bath. ",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 20,
